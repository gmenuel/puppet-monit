  ...
  case $::osfamily {
    'Debian': {
      ...
      case $::lsbdistcodename {
        ...
        'wheezy', 'jessie', 'stretch', 'buster', 'bullseye', 'bookworm', 'precise', 'trusty', 'xenial', 'bionic': {
          $default_file_content = 'START=yes'
          $service_hasstatus    = true
        }
        default: {
          fail("monit supports Debian 6 (squeeze), 7 (wheezy), 8 (jessie), 9 (stretch), 10 (buster), 11 (bullseye) and 12 (bookworm) \
